...
/**
 * Questa classe permette di leggere da tastiera le richieste dell'utente in modo da gestire eventuali errori
 */ 
public class Keyboard {
	...
	// ************* Error Handling Section **************************
		 ...
		 * @return the next token from the input, which may come from the current input line or a subsequent one.
		 */
