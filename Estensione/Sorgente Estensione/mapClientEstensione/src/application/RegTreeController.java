...
public class RegTreeController implements Initializable {
	...
	*/
	 ...
	 * più righe di testo. In questa applicazione è non modificabile e mostra l'albero di regressione.
	 */
	@FXML
	 ...
	 * @param resources, usato per localizzare la root delll'oggetto, null se non è localizzataa
	 * 
	 */
	@Override
