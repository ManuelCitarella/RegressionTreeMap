...
#tabella per testare l'eccezione "0 rows "
CREATE TABLE MapDB.provaEmpty( X varchar(10), Y float(5,2), C float(5,2));

#tabella per testare l'eccezione "table less 2 columns"
CREATE TABLE MapDB.provaD( X varchar(10));

 insert into MapDB.provaD values('A');
...
#tabella per testare l'eccezione " colonna del class discreta"
CREATE TABLE MapDB.provaCont( X varchar(10), Y float(5,2), C varchar(5));

 insert into MapDB.provaCont values('A',2,'1');

 insert into MapDB.provaCont values('A',2,'1');

 insert into MapDB.provaCont values('A',1,'1');

 insert into MapDB.provaCont values('A',2,'1');

 insert into MapDB.provaCont values('A',5,'1.5');

 insert into MapDB.provaCont values('A',5,'1.5');
 

#tabella per testare l'eccezione "null value in row"
CREATE TABLE MapDB.provaNull( X varchar(10), Y float(5,2), C float(5,2));

 insert into MapDB.provaNull values('A',2,1);

 insert into MapDB.provaNull values(null,2,1);

 insert into MapDB.provaNull values('A',1,1);
 ...
 insert into MapDB.servo values('A','A',6,5, 0.8062546);
  ...
  create table MapDB.servo2(motor varchar(10), screw varchar(10), pgain varchar(10), vgain varchar(10), class double);

 insert into MapDB.servo2 values('E','E','5','4', 0.28125095);

 insert into MapDB.servo2 values('B','D','6','5', 0.5062525);

 insert into MapDB.servo2 values('D','D','4','3', 0.35625148);

 insert into MapDB.servo2 values('B','A','3','2', 5.500033);

 insert into MapDB.servo2 values('D','B','6','5', 0.35625148);

 insert into MapDB.servo2 values('E','C','4','3', 0.8062546);

 insert into MapDB.servo2 values('C','A','3','2', 5.100014);
